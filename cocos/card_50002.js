...
function(e) {
    ...
    t.prototype.update_Time = function() {
        this.jump_time += 1,
        this.result_tme += 1,
        this.result_tme == this.result_max_time && (this.result_tme = 0, 0 == u._gameStateData.is_pause && s._duidie_view.add_card(r.cardNameOrId.牛奶, this.node.position, l.NumberUtil.randomNum(1, 8))),
