...
function(e) {
    ...
    t.prototype.update_Time = function() {
        ...
        if (1 != s._duidie_view.jiesuan) {
            if (this.jump_time += 1, this.result_tme += 1, this.result_tme == this.result_max_time && (this.result_tme = 0, 0 == p._gameStateData.is_pause && 0 == this.is_battle)) {
                var e = r.cardNameOrId.鸡蛋;
                this.card_class.cradId == r.cardNameOrId.牛 ? e = r.cardNameOrId.牛奶: this.card_class.cradId == r.cardNameOrId.兔子 && (e = r.cardNameOrId.大便),
                s._duidie_view.add_card(e, this.node.position, l.NumberUtil.randomNum(1, 8))
            }
            this.jump_time == this.jump_max_time && (this.jump_time = 0, this.is_jump && 0 == p._gameStateData.is_pause && this.cards.length <= 1 && d.default.jump(this,
            function() {}))
        }
    },
