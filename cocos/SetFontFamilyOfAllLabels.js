...
a.SetFontFamilyOfAllLabels = void 0;
var r = cc._decorator,
c = r.ccclass,
s = r.property,
d = function(e) {
    ...
    t.prototype.onLoad = function() {
        for (var e = 0,
        t = this.node.getComponentsInChildren(cc.Label); e < t.length; e++) {
            var a = t[e];
            a.font || (a.fontFamily = this.fontFamily)
        }
    },
    n([s], t.prototype, "fontFamily", void 0),
    n([c], t)
} (cc.Component);
a.SetFontFamilyOfAllLabels = d